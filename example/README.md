...
The example project builds a [ListView] of widgets that transition in
and out at the press of the action button.

Each widget's transition start is delayed 40ms after the widget before it,
resulting in a smooth cascading animation.

The document below is the example project's `lib/main.dart` file.
